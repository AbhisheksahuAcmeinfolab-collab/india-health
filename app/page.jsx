...
//         <h2 className="uppercase mb-4">HERO CAROUSEL</h2>

//         {/* ✅ Add ID to button for jQuery selector */}
//         <button
//           id="button"
...
//         {/* ✅ Add class 'demo1' to target this div */}
//         <div className="demo1 mt-4 p-4 bg-green-300 rounded">
//           This content was hidden and will slide down 🚀
//         </div>
//       </div>
            ...
            <SwiperSlide key={i}>
              <div className="relative h-[70vh] sm:h-[80vh] flex items-center">
                ...
                <motion.div
                  ...
                  className="relative z-10 container mx-auto px-6 md:px-12 text-center md:text-left"
                >
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-snug text-white drop-shadow-md">
                    <span className="text-blue-400">{slide.title}</span>
                    <br />
                    <span>{slide.subtitle}</span>
                  </h2>
                  <p className="text-gray-200 text-sm sm:text-base md:text-lg mt-3 max-w-xl mx-auto md:mx-0">
                    {slide.desc}
                  </p>
                  <motion.button
