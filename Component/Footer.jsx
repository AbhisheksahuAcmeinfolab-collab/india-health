                ...
                <div>
                  <h4 className="text-sm text-white group-hover:text-cyan-400 transition-colors">
                    {i === 0
                      ...
                      : "The Rise of Medical Tourism in India: Trends, Facts, and Future Insights"}
                  </h4>
                </div>
              </motion.div>
            ))}
                ...
                <div>
                  <h4 className="text-sm text-white group-hover:text-cyan-400 transition-colors">
                    {i === 0
                      ...
                      : "Understanding the Importance of Matching Donors and Recipients: Factors Considered in Matching Stem Cell Donors and Recipients"}
                  </h4>
                </div>
              </motion.div>
            ))}
